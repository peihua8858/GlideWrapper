...
public class RoundedCornersTransformation extends BitmapTransformation {
    ...
    private static final String ID = "com.globalegrow.glideview.glide.RoundedCornersTransformation." + VERSION;
    ...
    public RoundedCornersTransformation(int radius, int margin, CornerType cornerType) {
        ...
        this.margin = margin;
        this.cornerType = cornerType == null ? CornerType.ALL : cornerType;
    }
